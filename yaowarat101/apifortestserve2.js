...
const connection = mysql.createConnection({
	...
	host: 'mysql5-7.chaiyohosting.com:3306',
...
app.post('/checkout/:u_Id', function (req, res) {
	var productlist;
	var userData;
	var orderId;
...
app.get('/checkout/:u_Id', function (req, res) {
	...
	var orderId;
	var date = new Date().toLocaleString().slice(0, 19).replace('T', ' ');
	$query = 'SELECT * from ywr_order INNER JOIN ywr_orderproduct ON ywr_orderproduct.o_Id = ywr_order.o_Id WHERE u_Id = ' + req.params.u_Id;
	console.log($query)
